...
from shfa.storages import OriginalFileStorage, IIIFFileStorage
...
class AbstractBaseModel(models.Model):
    """Abstract base model for all new tables in the SHFA backend.
...
class AbstractImageModel(AbstractBaseModel):
    """Abstract image model for new image models in the SHFA backend. Supplies all images
    with a corresponding UUID and file upload.

    Args:
        AbstractBaseModel (models.Model): The abstract base model for all models in SHFA
    """
...
class AbstractTIFFImageModel(AbstractImageModel):
    """
    Abstract image model for new TIFF images in the SHFA backend. Beside supplying all images with a 
